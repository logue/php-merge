...
abstract class AbstractPhpMergeTest extends TestCase
{
     ...
     *
     * @return \PhpMerge\PhpMergeInterface The merger used in the subsequent tests.
     */
     ...
     */
    public function testSameChange():void
    {
     ...
     */
    public function testSingleChange():void
    {
        $base = self::split('12345');
        $text = self::split('123456');
     ...
     * @group double-line
     */
    public function testDuplicatedLines():void
    {
...
EOD;
     ...
     *
     * @param string $string     The string which is split into new lines.
     * @param int    $emptyLines The amount of empty new lines at the end of the string.
     *
     * @return string A string with new-line characters inserted between all characters.
     */
    protected static function split(string $string, int $emptyLines = 1):string
    {
